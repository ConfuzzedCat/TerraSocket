...
namespace TerraSocket
{
    ...
    class TerraPatches
    {
        ...
        static void PlayerDamaged(ModPlayer __instance, NPC npc, int damage, bool crit)
        {
            ...
            WebSocketServerHelper.SendWSMessage(new WebSocketMessageModel("PlayerDamaged", true, new WebSocketMessageModel.ContextInfo(playerName, new WebSocketMessageModel.ContextInfo.ContextPlayerDamage(damage, crit, false, false, 0, "NPC", npcName))));
        }
        ...
        static void PlayerHitWithProj(Projectile proj, int damage, bool crit, ModPlayer __instance)
        {
            ...
            WebSocketServerHelper.SendWSMessage(new WebSocketMessageModel("PlayerDamaged", true, new WebSocketMessageModel.ContextInfo(playerName, new WebSocketMessageModel.ContextInfo.ContextPlayerDamage(damage, crit, false, false, 0, "PROJECTILE", projName))));
        }
